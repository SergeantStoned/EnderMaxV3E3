 ...
 */
#define USE_CONTROLLER_FAN                  // EDITED!
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN       PB15     // Set a custom pin for the controller fan    // FAN2 Control Board
  //#define CONTROLLER_FAN_USE_Z_ONLY       // With this option only the Z axis is considered
  //#define CONTROLLER_FAN_IGNORE_Z         // Ignore Z stepper. Useful when stepper timeout is disabled.
  #define CONTROLLERFAN_SPEED_MIN       64  // (0-255) Minimum speed. (If set below this value the fan is turned off.)    // Standard value: 0
 ...
 */
#define E0_AUTO_FAN_PIN PC7                  // FAN1 for hot-end
...
#define CHAMBER_AUTO_FAN_PIN PC6             // FAN0 for part cooling
#define COOLER_AUTO_FAN_PIN -1
#define COOLER_FAN_PIN -1           

#define EXTRUDER_AUTO_FAN_TEMPERATURE 40       // Standard value: 50
...
// @section bltouch
   ...
   */
  #define BLTOUCH_HS_MODE true    //EDITED, deactivate if probing fails!
 ...
 */
//#define XY_FREQUENCY_LIMIT      10 // (Hz) Maximum frequency of small zigzag infill moves. Set with M201 F<hertz>.    ACTIVATE IF NEEDED! Seems useful
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING       // Comment out if prints succ!
...
// LCD Print Progress options
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY         // Deactivated because it seems buggy atm.
 ...
 */
  ...
  #define Z_HYBRID_THRESHOLD       20     // MAYBE CHANGE BACK TO 3 IF SUS!
