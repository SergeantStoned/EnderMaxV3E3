config.h & config_adv.h for the Ender Max with a Bigtreetech SKR Mini E3 V3 and CR-Touch z-homing
with the original 5-pin of the mainboard.
...
POWER_LOSS_RECOVERY feature is once again deactivated, lol.
